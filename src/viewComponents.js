...
const settingsEditor = ({selectedSettings: settings}, action) => settings === null ? div('no setting selected') : div(
	...
	form(
		...
		button({type: 'button', onclick: setInputs('abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', '0123456789', '-%$#.!@&*()', 40)}, "Default"),
		br(),
		...
		input({name: "symbols", value: stringFilter(/[^a-zA-z^0-9]/)(settings.alphabet)}),
